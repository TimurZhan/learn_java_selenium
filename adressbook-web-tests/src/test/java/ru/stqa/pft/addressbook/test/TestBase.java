...
@Listeners(MyTestListener.class)//При помощи данной аннотации цепляем скриншот к отчетам Allure, в случае ошибок
public class TestBase {
  ...
  public void setUp(ITestContext context) throws Exception {
    app.init();
    context.setAttribute("app", app);//Получаем доступ к контексту выполнения тестов (ссылку на ApplicationManager)
  }
